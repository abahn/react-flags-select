...
var ReactFlagsSelect = function (_Component) {
	...
	function ReactFlagsSelect(props) {
		...
		var countrySorted = selectCountries || fullCountries;

		if (_this.props.relevantCountries) {
			countrySorted.sort(_this.sortByRelevance.bind(_this));
		}
	...
	ReactFlagsSelect.prototype.sortByRelevance = function sortByRelevance(countryCodeFirst, countryCodeSecond) {
		var result = 0;
		var isFirstRelevant = this.props.relevantCountries.indexOf(countryCodeFirst) >= 0;
		var isSecondRelevant = this.props.relevantCountries.indexOf(countryCodeSecond) >= 0;
	...
	ReactFlagsSelect.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			this.state.openOptions && _react2.default.createElement(
				...
				(this.state.filter ? this.state.filteredCountries : this.state.countries).slice(0, this.props.displayingLimit).map(function (countryCode) {
					return _react2.default.createElement(
						'div',
...
ReactFlagsSelect.propsType = {
	...
	displayingLimit: _propTypes2.default.number,
	relevantCountries: _propTypes2.default.arrayOf(_propTypes2.default.string),
